export const en = {
  ...
  apiKeys: {
    actions: {
      ...
      addOllamaProvider: "Add Ollama Provider",
    ...
    labels: {
      ...
      apiKeysOptional: "API Key(s) (optional)",
    ...
    ollamaDescription:
      "Add Ollama providers using native Ollama endpoints only.",
    placeholders: {
      ...
      providerHeaders: "CF-Access-Client-Id: ...\nCF-Access-Client-Secret: ...",
    ...
    toasts: {
      ...
      atLeastOneApiKeyOrHeaderRequired: "At least one API key or header required",
